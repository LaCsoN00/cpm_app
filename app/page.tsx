      ...
      <div>
        ...
        <dialog id="my_modal_3" className="modal">
          <div className="modal-box">
            ...
            <h3 className="font-bold text-lg">Informations Relatives aux Clients</h3>
            <br />
            <div>
              <input
        ...
        <div className="w-full">
          {projects.length > 0 ? (
            ...
            <div>
              <EmptyState imageSrc="/empty-project.png" imageAlt="Picture of an empty project" message="Aucun projet Créé" />
            </div>
          )}
        </div>
      </div>
